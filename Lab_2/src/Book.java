...
public class Book {
    ...
    public static Book[] createMas(int n) {
        Book mas[] = new Book[n];
        mas[0] = new Book("BTS", "BTS", 2015, 200);
        mas[1] = new Book("Avsyanova", "English", 2005, 50);
        return mas;
    }
    ...
    public static void spisA1(Book[] mas) {
        ...
        for (int i = 0; i < mas.length; i++) {
            mas[i].author = mas[i].author.replaceAll(mas[i].author, "OneDirection");
            mas[i].show();
        }
        System.out.println();
    }
    public static void spisA2(Book[] mas) {
        ...
        for (int i = 0; i < mas.length; i++) {
            mas[i].name = mas[i].name.replaceAll(mas[i].name, "TICK");
            mas[i].show();
        }
        System.out.println();
    }
