...
public class Patient {
    ...
    public String toString() {
        return "Patient\n id=" + id + ", number=" + numberOfCard + "\nname=" + name + " lastName=" + lastName + " middleName=" + middleName + ", address=" +
                address + "\nphone=" + phoneNumber + "\ndiagnosis=" + diagnosis;
    }
    public void show() {
        System.out.println("id: " + this.id + "\nlastName: " + this.lastName + "name: " + this.name + " middleName:" + this.middleName + "\naddress:" + this.address + "\nphone:" + this.phoneNumber + "\nnumber: " + numberOfCard + "\ndiagnosis: " + diagnosis);
    }
    public static Patient[] patientsArrayCreation(int n) {
        Patient patientsArray[] = new Patient[n];
        patientsArray[0]=new Patient(1,"Петр","Петров","Петрович","ул.Артурно,д2", 1234567, 29,"Бронхит");
        patientsArray[1]=new Patient(2,"Иван","Иванов","Иванович","ул.Марченкова, д6",7654321,10,"Отит");
