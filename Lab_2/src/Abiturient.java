...
public class Abiturient {
    ...
    public static Abiturient[] abiturientArrayCreate(int n){
        ...
        abitArray[0] = new Abiturient(1,"Ваня","Ваня","Вованыч","ул.Артурно,д1", "2281488",createArray(3,4,5));
        abitArray[1] = new Abiturient(2,"Петя","Петя","Вованыч","ул.Артурно,д2","1234567",createArray(8,7,9));
        abitArray[2] = new Abiturient(3,"Вова","Вова","Вованыч","ул.Артурно,д3", "01091939",createArray(9,9,10));
        return abitArray;
    }
    ...
    public static void listAvgRating(Abiturient[] abitArray, int rating){
        ...
        int avg = abitArray[i].avg(abitArray[i].rating);
            if (avg >= rating){
                System.out.println("Ср.балл "+avg+". Абитуриент: "+abitArray[i].toString());
            }
        }
    }
